          ...
          <div class="iso-workspace">
            ...
            <section class="iso-panel iso-inspector-panel">
              ...
              <div class="iso-detail-body" v-if="selectedExplorerControl">
                ...
                <div><span class="iso-detail-label">Interpretasi</span><div class="iso-note">{{ selectedExplorerControl.interpretation || '-' }}</div></div>
                ...
                <div class="iso-concept-workspace">
                  ...
                  <section class="iso-panel">
                    ...
                    <div class="iso-detail-body" v-if="selectedConceptControl">
                      ...
                      <div><span class="iso-detail-label">Interpretasi</span><div class="iso-note">{{ selectedConceptControl.interpretation || '-' }}</div></div>
