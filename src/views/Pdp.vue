        ...
        <div v-if="activeTab === 'explorer'" key="explorer-tab">
          <div class="sej-workspace">
            <article class="sej-panel">
              ...
              <div class="sej-summary"><small>Requirement Ditampilkan</small><strong>{{ filteredRequirements.length }}</strong><span>{{ filteredRequirements.length ? `Menampilkan ${filteredRequirements.length} requirement UU PDP sesuai filter aktif.` : 'Tidak ada requirement yang cocok dengan filter saat ini.' }}</span></div>
            </article>
            <article class="sej-panel">
