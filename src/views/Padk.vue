...
[data-bs-theme="dark"] .sej-page{--ink:#f8fafc;--muted:#94a3b8;--line:rgba(255,255,255,.1);background:linear-gradient(180deg,#0f172a,#1e293b)}[data-bs-theme="dark"] .sej-metric,[data-bs-theme="dark"] .sej-side,[data-bs-theme="dark"] .sej-panel,[data-bs-theme="dark"] .sej-mini,[data-bs-theme="dark"] .sej-tab,[data-bs-theme="dark"] .sej-item,[data-bs-theme="dark"] .sej-pillar,[data-bs-theme="dark"] .sej-card,[data-bs-theme="dark"] .sej-callout{background:rgba(30,41,59,.65);border-color:rgba(255,255,255,.1)}[data-bs-theme="dark"] .sej-note,[data-bs-theme="dark"] .sej-item.active,[data-bs-theme="dark"] .sej-pillar.active{background:rgba(30,41,59,.88);border-color:var(--accent,#48cae4)}[data-bs-theme="dark"] .modal-shell{display:flex;flex-direction:column;max-height:85vh;border-radius:20px;overflow:hidden;background:#fff;box-shadow:0 24px 64px rgba(15,23,42,.24),0 8px 24px rgba(15,23,42,.12)}[data-bs-theme="dark"] .modal-artifact-list li{background:rgba(255,255,255,.05)}
@media (max-width:991.98px){.sej-workspace,.sej-refspace{grid-template-columns:1fr}.sej-inspector{min-height:auto}}@media (max-width:1199.98px){.sej-hero,.sej-nav,.sej-grid.two,.sej-metrics,.sej-mini-row,.sej-cards{grid-template-columns:1fr}.sej-bar,.sej-hotspot{grid-template-columns:1fr}}@media (max-width:767.98px){.sej-hero,.sej-panel{padding:1.2rem;border-radius:22px}.sej-form{flex-direction:column;align-items:stretch}.modal-shell{display:flex;flex-direction:column;max-height:85vh;border-radius:20px;overflow:hidden;background:#fff;box-shadow:0 24px 64px rgba(15,23,42,.24),0 8px 24px rgba(15,23,42,.12)}.modal-sidebar{position:relative;display:flex;flex-direction:row;align-items:center;justify-content:flex-start;gap:.85rem;padding:1rem 1.5rem;color:#fffaf2;text-align:left;flex-shrink:0}.sej-list,.sej-inspector-body{max-height:none;overflow:visible}}
</style>
