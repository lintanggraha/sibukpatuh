...
@media (max-width:991.98px){.sej-workspace,.sej-refspace{grid-template-columns:1fr}.sej-inspector{min-height:auto}}@media (max-width:1199.98px){.sej-hero,.sej-nav,.sej-grid.two,.sej-metrics,.sej-mini-row,.sej-cards{grid-template-columns:1fr}.sej-bar,.sej-hotspot{grid-template-columns:1fr}}@media (max-width:767.98px){.sej-hero,.sej-panel{padding:1.2rem;border-radius:22px}.sej-form{flex-direction:column;align-items:stretch}.modal-shell{grid-template-columns:1fr}.modal-sidebar{flex-direction:row;padding:1rem}.sej-list,.sej-inspector-body{max-height:none;overflow:visible}}
</style>
