        ...
        <div v-if="activeTab === 'explorer'" key="explorer-tab">
          <div class="sej-workspace">
            <article class="sej-panel">
              ...
              <div class="sej-summary"><small>Hasil Pencarian</small><strong>{{ filteredRequirements.length }}</strong><span>{{ filteredRequirements.length ? `Menampilkan ${filteredRequirements.length} kriteria pengujian OWASP ASVS.` : 'Tidak ada kriteria yang cocok dengan pencarian.' }}</span></div>
            </article>
            <article class="sej-panel">
...
export default {
  ...
  data() {
    return {
      ...
      appendices: [],
      pillarMeta: {
        'Architecture': { label: 'Arsitektur', color: '#1d4ed8', icon: 'fa-sitemap', summary: 'Tata letak dan ancaman desain logikal.' },
        'Authentication': { label: 'Logika & Akses', color: '#b91c1c', icon: 'fa-user-shield', summary: 'Manajemen login, wewenang, sesi.' },
        'Validation': { label: 'Validasi Input', color: '#a16207', icon: 'fa-filter', summary: 'Filter masukan, kode rahasia, dan sanitasi.' },
        'Data Protection': { label: 'Proteksi Data offline', color: '#7c3aed', icon: 'fa-database', summary: 'Kriptografi data at rest.' },
        'Communication': { label: 'Jaringan & Server', color: '#0f766e', icon: 'fa-network-wired', summary: 'SSL/TLS dan mitigasi parameter server.' },
      },
      chapterMeta: {
        'V1': { label: 'Architecture & Design', color: '#1d4ed8', icon: 'fa-drafting-compass', summary: 'Aspek desain dasar sistem.' },
        'V2': { label: 'Authentication', color: '#b91c1c', icon: 'fa-id-card', summary: 'Verifikasi identitas.' },
        'V3': { label: 'Session Management', color: '#c2410c', icon: 'fa-history', summary: 'Masa aktif akses kontrol pengguna.' },
        'V4': { label: 'Access Control', color: '#a16207', icon: 'fa-key', summary: 'Akses tingkat fitur operasional.' },
        'V5': { label: 'Validation/Sanitization', color: '#0f766e', icon: 'fa-broom', summary: 'Sanitasi masukan berbahaya.' },
        'V6': { label: 'Stored Cryptography', color: '#7c3aed', icon: 'fa-lock', summary: 'Perlindungan offline file.' },
        'V12': { label: 'Secure Communication', color: '#144e72', icon: 'fa-satellite-dish', summary: 'Keamanan tunnel network transit.' },
        'V14': { label: 'Configuration', color: '#b45309', icon: 'fa-sliders-h', summary: 'Pengaturan webserver dan OS layer.' },
      },
      appendixTypePalette: {
