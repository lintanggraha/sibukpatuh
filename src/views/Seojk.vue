        ...
        <div v-if="activeTab === 'explorer'" key="explorer-tab">
          <div class="sej-workspace">
            <article class="sej-panel">
              ...
              <div class="sej-summary"><small>Requirement Ditampilkan</small><strong>{{ filteredRequirements.length }}</strong><span>{{ filteredRequirements.length ? `Menampilkan ${filteredRequirements.length} requirement SEOJK sesuai filter aktif.` : 'Tidak ada requirement yang cocok dengan filter saat ini.' }}</span></div>
            </article>
            <article class="sej-panel">
            ...
            <article class="sej-panel sej-inspector">
              ...
              <div class="sej-inspector-body">
                ...
                <div class="sej-note"><span class="sej-label">Interpretasi Implementasi</span><div class="mt-2">{{ activeRequirement ? activeRequirement.interpretation : '-' }}</div></div>
