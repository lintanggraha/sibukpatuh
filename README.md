...
```
cd existing_repo
git remote add origin https://cbsc-git-repo.collega.co.id/lintang.prasetya/sibukpatuh.git
git branch -M main
...
- [ ] [Set up project integrations](https://cbsc-git-repo.collega.co.id/lintang.prasetya/sibukpatuh/-/settings/integrations)
...
>>>>>>> 54a56900561b94dfb9f454ec90e559f023707273
