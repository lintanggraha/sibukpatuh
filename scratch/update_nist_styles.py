...
file_path = r'c:\laragon\www\sibukpatuh-vue\src\views\Nist.vue'
...
# Find the start of the style block in the original content
style_start = content.find('<style scoped>')
if style_start != -1:
    # Everything before the style block
    head = content[:style_start]
    # Reassemble with the new style block
    new_content = head + new_style + '\n'
    
    with open(file_path, 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("Successfully updated Nist.vue style block.")
else:
    print("Could not find <style scoped> in Nist.vue")
